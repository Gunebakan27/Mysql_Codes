...
select urun_id, musteri_isim from mart 
 ...
 -----------------------------------------------------------------------------*/
 select urun_isim, musteri_isim from nisan n -- tablo ismini kisaltabiliriz ama sadece yapilan sorguda gecerlidir.
...
==============================================================================*/
 ...
 -- Soru 1: isim null olanlari sorgula
 select * from insanlar where isim is null;
  -- Soru 2: isim null olmayanlari sorgula
...
select *  from kisiler where soyisim='bulut' order by 5 desc;-- maas in sütun nosu da yazilabilir

-- ******************* L I M I T ***********************
-- listeden ilk 10 tanesini getir
select * from kisiler limit 10;

-- 10. veriden sonraki 2 veriyi getir (11 ve 12)

select * from kisiler limit 10; -- 10dan sonraki 2 veriyi getir
