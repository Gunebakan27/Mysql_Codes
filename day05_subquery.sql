...
-- in yerine = olmaz cünkü = 1 adet veri icin yazilabilir..
...
==============================================================================*/   
 ...
 -----------------------------------------------------------------------------*/
 select marka_isim, calisan_sayisi, (select sum(maas) from calisanlar where marka_isim=isyeri) as toplam_maas -- as toplam_maas : parantes icine isim vermek icin
 from markalar; 
 /* -----------------------------------------------------------------------------
 ...
 , (select max(maas) from calisanlar where marka_isim=isyeri) as max_maas -- as toplam_maas : parantes icine isim vermek icin
