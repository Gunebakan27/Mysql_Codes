...
/*-----------------------------------------------------------------------------
 ...
 degistiriniz.
 -----------------------------------------------------------------------------*/
   update urunler, tedarikciler set urun_isim=firma_ismi where musteri_isim='Ali Bak'
   and irtibat_ismi='Adam Eve';
...
/*------------------------------------------------------------------------------
 ...
 degistirin
  -----------------------------------------------------------------------------*/
  update urunler, tedarikciler set musteri_isim=irtibat_ismi where urun_isim='Laptop'
   and firma_ismi='Apple';
   
   update urunler set musteri_isim=(select irtibat_isim from tedarikciler
 where firma_isim='Apple') where urun_isim='Laptop';