...
select isim isim_sehir, maas from personel
...
order by maas desc;
/* -----------------------------------------------------------------------------
  ORNEK3: Honda,Ford ve Tofas'ta calisan personelin isimlerini varsa listeleyin
------------------------------------------------------------------------------*/  
...
------------------------------------------------------------------------------*/   
select sehir sehir_tel, maas maas_cocuk from personel
where id='123456789'
union
