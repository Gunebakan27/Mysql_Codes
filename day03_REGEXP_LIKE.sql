...
/* ========================================================================== */
    ...
    INSERT INTO kelimeler VALUES (1014, 'haaat', 5);
     INSERT INTO kelimeler VALUES (1016, 'hororot', 4);
...
/* -----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/ 
    ...
    where regexp_like (kelime, 'h[a-zA-Z0-9]t','c');
       ...
       select * from kelimeler 
    where kelime like 'h_t'; -- case sensetive degil
...
-----------------------------------------------------------------------------*/ 
  select * from kelimeler 
    ...
    select * from kelimeler 
    where regexp_like (kelime, '[o]{2}');-- yanyana o olmasi lazim
      select * from kelimeler 
    where regexp_like (kelime, '[o][o]'); -- yanyana o olmasi lazim
